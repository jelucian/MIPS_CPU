...
HD_PWD='C:/Users/Jesus Luciano/Desktop/Execution_Unit/Execution_Unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Integer_Datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Integer_Datapath.tcl
